...
video.on('progress', (chunkLength, downloaded, total) => {
  ...
  process.stdout.write(`, running for: ${download_time.toFixed(2)}minutes`);
  process.stdout.write(`, estimated time left: ${(download_time / float_downloaded - download_time).toFixed(2)}minutes`);
});
video.once('end', () => {
