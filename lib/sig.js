...
exports.getTokens = function(html5playerfile, options, callback) {
  ...
  if (cachedTokens) {
    ...
    if (html5playerfile.lastIndexOf('/', 0) === 0 && html5playerfile.lastIndexOf('//', 0) !== 0) html5playerfile = 'https://www.youtube.com' + html5playerfile; //youtube forces https and www. otherwise we get a 301
    else html5playerfile = 'http:' + html5playerfile; //support for old way just in case
