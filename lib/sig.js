...
exports.getTokens = function(html5playerfile, options, callback) {
  ...
  if (cachedTokens) {
    ...
    if (html5playerfile[0] === '/' && !html5playerfile.startsWith('//')) html5playerfile = 'https://www.youtube.com' + html5playerfile; //youtube forces https and www. otherwise we get a 301
