...
/**
 * @param {String} videoDescriptionHtml
 * @return {String}
 */
exports.cleanVideoDescription = function(videoDescriptionHtml) {
  if (!videoDescriptionHtml || videoDescriptionHtml == null)
    return null;
  return entities.decode(videoDescriptionHtml
    .replace(/\n/g, ' ')
