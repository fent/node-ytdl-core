...
/**
 * Object.assign for older node versions.
 *
 * @param {Object} obj1
 * @param {Object} obj2
 * @return {Object}
 */
exports.concatObjects = function(obj1,obj2) {
  var obj3 = {};
...
exports.getAuthor = function(body) {
  var ownerinfo = this.between(body, '<div id="watch7-user-header" class=" spf-link ">', '<div id="watch8-action-buttons" class="watch-action-buttons clearfix">');
  ownerinfo = new Entities().decode(ownerinfo)
  if (ownerinfo === '') {
	  return {};
  }
  let match = ownerinfo.match(authorRegexp);
  return {
	'type':'channel',
	'ref':'/channel/'+match[1],
	'id':match[1],
	'name':match[2],
	'avatar':this.between(ownerinfo, 'data-thumb="','"'),
	'aka': (ownerinfo.includes('/user/') ? '/user/'+ownerinfo.match(aliasRegExp)[1] : 'none'),
  };
};
...
exports.getRelatedVideos = function(body) {
  var jsonStr = this.between(body, '\'RELATED_PLAYER_ARGS\': {"rvs":','},')
  try {
  ...
  var unparsed_videos = jsonStr.split(',')
  return unparsed_videos.map(function(link) {
